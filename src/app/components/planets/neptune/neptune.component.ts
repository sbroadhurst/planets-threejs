...
export class NeptuneComponent implements OnInit, AfterViewInit {
  ...
  private neptune = new THREE.Mesh();
  ...
  ngOnInit(): void {
    ...
    // makes the neptune move on mouse move
  ...
  private createScene() {
        ...
        uniforms: {
          globeTexture: {
            value: new THREE.TextureLoader().load(
              'assets/planets/neptune/neptune_map.jpg'
            ),
          },
          transparent: {
            value: 1,
    ...
    this.atmosphere = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
        ...
        side: THREE.BackSide,
        uniforms: {
          rgb: { value: new THREE.Vector3(0.21, 0.77, 0.905) },
        },
      })
    );
