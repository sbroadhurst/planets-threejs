...
export class JupiterComponent implements OnInit, AfterViewInit {
  ...
  private jupiter = new THREE.Mesh();
  ...
  ngOnInit(): void {
    ...
    // makes the jupiter move on mouse move
  ...
  private createScene() {
        ...
        uniforms: {
          globeTexture: {
            value: new THREE.TextureLoader().load(
              'assets/planets/jupiter/jupiter_map.jpg'
            ),
          },
          transparent: {
            value: 1,
    ...
    this.atmosphere = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
        ...
        side: THREE.BackSide,
        uniforms: {
          rgb: { value: new THREE.Vector3(0.62, 0.62, 0.63) },
        },
      })
    );
