...
export class MercuryComponent implements OnInit, AfterViewInit {
  ...
  private mercury = new THREE.Mesh();
  ...
  ngOnInit(): void {
    ...
    // makes the mercury move on mouse move
  ...
  private createScene() {
        ...
        uniforms: {
          globeTexture: {
            value: new THREE.TextureLoader().load(
              'assets/planets/mercury/mercury_map.jpg'
            ),
          },
          transparent: {
            value: 1,
    ...
    this.atmosphere = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
        ...
        side: THREE.BackSide,
        uniforms: {
          rgb: { value: new THREE.Vector3(0.903, 0.904, 0.905) },
        },
      })
    );
