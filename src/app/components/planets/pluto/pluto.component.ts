...
export class PlutoComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // makes the pluto move on mouse move
  ...
  private createScene() {
        ...
        uniforms: {
          globeTexture: {
            value: new THREE.TextureLoader().load(
              'assets/planets/pluto/pluto_map.jpg'
            ),
          },
          transparent: {
            value: 1,
    ...
    this.atmosphere = new THREE.Mesh(
      ...
      new THREE.ShaderMaterial({
        ...
        side: THREE.BackSide,
        uniforms: {
          rgb: { value: new THREE.Vector3(0.01, 0.23, 0.64) },
        },
      })
    );
