...
export class MarsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    // makes the mars move on mouse move
        ...
        uniforms: {
          globeTexture: {
            value: new THREE.TextureLoader().load(
              'assets/planets/mars/8k_mars.jpg'
            ),
          },
          transparent: {
            value: 1,
